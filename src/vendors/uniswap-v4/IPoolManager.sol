...
interface IPoolManager {
  ...
  /// @param id The abi encoded hash of the pool key for the new pool
  ...
  /// @param id The abi encoded hash of the pool key for the pool that was modified
  ...
  /// @param id The abi encoded hash of the pool key for the pool that was donated to
