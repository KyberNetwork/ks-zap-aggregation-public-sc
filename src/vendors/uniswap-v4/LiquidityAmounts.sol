...
library LiquidityAmounts {
  ...
  function getAmount0ForLiquidity(uint160 sqrtPriceAX96, uint160 sqrtPriceBX96, uint256 liquidity)
    internal
    pure
  ...
  function getAmount1ForLiquidity(uint160 sqrtPriceAX96, uint160 sqrtPriceBX96, uint256 liquidity)
    internal
    pure
