...
library StateLibrary {
   ...
   */
  function getTickInfo(IPoolManager manager, bytes32 poolId, int24 tick)
    internal
    view
    returns (
   ...
   * @return liquidityNet The amount of net liquidity added (subtracted) when tick is crossed from left to right (right to left)
   */
  function getTickLiquidity(IPoolManager manager, bytes32 poolId, int24 tick)
    internal
    view
   ...
   */
  function getLiquidity(IPoolManager manager, bytes32 poolId)
    internal
    view
   ...
   */
  function getTickBitmap(IPoolManager manager, bytes32 poolId, int16 tick)
    internal
    view
   ...
   * @return liquidity The liquidity of the position.
   */
  function getPositionLiquidity(IPoolManager manager, bytes32 poolId, bytes32 positionId)
    internal
    view
    returns (uint128 liquidity)
  {
